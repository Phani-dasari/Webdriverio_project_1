...
class ScreenRecorder {
    ...
    async start() {
        ...
        try {
            ...
            await this._enforceTermination();
            throw this._log.errorWithException(`The expected screen record file '${this._videoPath}' does not exist. ` +
                `Check the server log for more details`);
        }
        this._log.info(`The video recording has started. Will timeout in ${support_1.util.pluralize('second', this._timeLimit, true)}`);
    }
 ...
 */
async function stopRecordingScreen(remotePath, user, pass, method, headers, fileFieldName, formFields) {
